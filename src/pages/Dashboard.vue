      ...
      <div class="col-lg-4" :class="{'text-right': isRTL}">
        <card type="chart">
          <template slot="header">
            ...
            <h3 class="card-title"><i class="tim-icons icon-delivery-fast text-info "></i> 3,500Bs.</h3>
          </template>
          <div class="chart-area">
    ...
    methods: {
      initBigChart(index) {
        let chartData = {
          ...
          labels: ['88.1', '88.9', '90.1', '93.9', '95.5', '97.7', '100.3', '103.3', '105.3', '106.6', '107.3', '107.9'],
        }
